...
import { BadgeIndianRupee, CalendarRange, CheckCircle, UserRoundCheck, Users, XCircle } from 'lucide-react';
...
const DashboardPage = () => {
    ...
    // to load doctor from the server
    useEffect(() => {
        let mounted = true;
        ...
        <div className={s.maxWidthContainer}>
            ...
            <div className={s.statsGrid}>
                ...
                <StatCard // shows count fetch from the backend
                    ...
                    patientCountLoading ? "Loading..." : (patientCount ?? totals.totalLoginPatients)
                } />
        ...
        <div className={s.mobileDoctorCard}>
            <div className={s.mobileDoctorHeader}>
                <div className="flex items-center gap-3">
                    <img src={d.image} alt={d.image} className={s.mobileDoctorImage} />
                    <div>
