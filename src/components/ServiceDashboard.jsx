...
const API_BASE = "https://hospitalbackend-rhq9.onrender.com";
...
const ServiceDashboard = ({ services: servicesProp = null }) => {
    ...
    //  Helper function to build fetch options with auth token
    ...
    useEffect(() => {
        ...
        // refresh when localStorage key is updated in another tab (after booking an appointment for a service)
        ...
        //    Also refresh when the tab becomes active again (in case they made changes in another tab)
    ...
    //  filter and search logic for the services list
        ...
        <div className={serviceDashboardStyles.container}>
            <div className={serviceDashboardStyles.innerContainer}>
                ...
                <div className={serviceDashboardStyles.header.container}>
                    ...
                    <div className={serviceDashboardStyles.refresh.container}>
                        ...
                        <button onClick={() => {
                            ...
                            fetchServices({ showLoading: true })
                        }} className={serviceDashboardStyles.refresh.button(Array.isArray(servicesProp))} title={Array.isArray(servicesProp) ? "Services provided by parent component" : "Refresh"}>
                            Refresh
                        </button>
                ...
                <div className={serviceDashboardStyles.table.container}>
                    ...
                    <div className={serviceDashboardStyles.tableBody}>
                        {loading ? (
                            <div className={serviceDashboardStyles.stateLoading}>
                                Loading services...
                            </div>
                        ) : error ? (
                            <div className={serviceDashboardStyles.stateError}>
                                Error: {error}
                            </div>
                        ) : visibleServices.length === 0 ? (
                            <div className={serviceDashboardStyles.stateEmpty}>
                                No services found.
                            </div>
                        ) : (
                            visibleServices.map((s)=> {
                                ...
                                return (
                                    <div key={s._id} className={serviceDashboardStyles.table.row}>
                                        ...
                                        <div className={serviceDashboardStyles.table.desktopView}>
                                            ...
                                            <div
                                                className={`${serviceDashboardStyles.table.desktopCenterCell(2)} text-right`}
                                            >
                                                {formatCurrency(earning)}
                                            </div>
...
function StatCard({ icon, label, value }) {
    return (
        <div className={serviceDashboardStyles.statCard.container}>
            ...
            <div>
                <div className={serviceDashboardStyles.statCard.label}>
                    {label}

                </div>
                <div className={serviceDashboardStyles.statCard.value}>
                    {value}
