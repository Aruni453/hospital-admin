...
const AppointmentsPage = () => {
  const isAdmin = true;
  //as the admin is logged in aand is major admin here
  ...
  //compute availaibilities specialities from fetched appointments
  ...
  //  sort filtered in descending Order
  ...
  // display all the appointment on the filtered ones
  const displayed = useMemo(
    () => (showAll ? sortedFiltered : sortedFiltered.slice(0, 8)),
    [sortedFiltered, showAll]
  );
  // if admin wants to can cel appointment
