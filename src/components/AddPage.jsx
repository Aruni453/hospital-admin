...
import { User, XCircle, Eye, EyeClosed, Plus, Trash2, CheckCircle, Calendar } from "lucide-react";


// Helper Functions
// this function will give output inn minutes and according to that it will manage am : pm
...
// this function will convert (YYYY-MM-DD) to Date Month
...
const AddPage = () => {
  ...
  function addSlotToForm() {
    ...
    // if slot os of today then prevent from time
    if (slotDate === today) {
      const now = new Date();
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      const API_BASE = "https://hospitalbackend-rhq9.onrender.com/api";
